...
class ProductResourceIT {
    ...
    private static final Size DEFAULT_SIZY = Size.S;
    private static final Size UPDATED_SIZY = Size.M;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getSizy()).isEqualTo(DEFAULT_SIZY);
    ...
    @Test
    @Transactional
    void checkSizyIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setSizy(null);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].sizy").value(hasItem(DEFAULT_SIZY.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.sizy").value(DEFAULT_SIZY.toString()))
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getSizy()).isEqualTo(UPDATED_SIZY);
